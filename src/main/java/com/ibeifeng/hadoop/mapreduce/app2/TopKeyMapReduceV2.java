 ...
 * 
 */
public class TopKeyMapReduceV2 extends Configured implements Tool{
	/**
	 * 
	 * Mapper 实现类
	 * 
	 * 
	 */
	public static class TopKeyV2Mapper extends
	...
	public int run(String[] args) throws Exception {
		...
		//2) mapper class
		job.setMapperClass(TopKeyV2Mapper.class);
...
//		job.setGroupingComparatorClass(LongWritable.Comparator.class);
	...
	public static void main(String[] args) throws Exception {
		...
		//run mapreduce
		int status = ToolRunner.run(conf, new TopKeyMapReduceV2(), args);
