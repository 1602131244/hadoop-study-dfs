...
public class PartitionerWCMapReduce extends Configured implements Tool{
	/**
	 * 
	 * Mapper 实现类
	 * 
...
//		job.setGroupingComparatorClass(LongWritable.Comparator.class);
	...
	public static void main(String[] args) throws Exception {
		args = new String[] {
				...
				"hdfs://hadoop-yarn.beifeng.com:8020/user/beifeng/mr/wordcount/part-output"
		...
		//run mapreduce
		int status = ToolRunner.run(conf, new PartitionerWCMapReduce(), args);
