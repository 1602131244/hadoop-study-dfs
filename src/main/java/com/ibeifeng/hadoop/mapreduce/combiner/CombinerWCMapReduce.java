package com.ibeifeng.hadoop.mapreduce.combiner;
...
public class CombinerWCMapReduce extends Configured implements Tool{
	/**
	 * 
	 * Mapper 实现类
	 * 
...
//		job.setGroupingComparatorClass(LongWritable.Comparator.class);
	...
	public static void main(String[] args) throws Exception {
		args = new String[] {
				...
				"hdfs://hadoop-yarn.beifeng.com:8020/user/beifeng/mr/wordcount/combiner-output"
		...
		//run mapreduce
		int status = ToolRunner.run(conf, new CombinerWCMapReduce(), args);
